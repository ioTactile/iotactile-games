          ...
          <tbody>
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.one === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.one === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.two === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.two === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.three === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.three === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.four === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.four === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.five === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.five === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.six === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.six === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center bg-diceClosePrimary border-darker">
                <span class="font-weight-bold">{{
                  checkUpperSubtotalPlayerOne !== 0
                    ? checkUpperSubtotalPlayerOne
                    : ''
                }}</span>
              </td>
              <td class="text-center bg-diceClosePrimary border-darker">
                <div v-if="scores.playerTwo">
                  <span class="font-weight-bold">{{
                    checkUpperSubtotalPlayerTwo !== 0
                      ? checkUpperSubtotalPlayerTwo
                      : ''
                  }}</span>
                </div>
              </td>
              <td class="text-center bg-diceClosePrimary border-darker">
                <div v-if="scores.playerThree">
                  <span class="font-weight-bold">{{
                    checkUpperSubtotalPlayerThree !== 0
                      ? checkUpperSubtotalPlayerThree
                      : ''
                  }}</span>
                </div>
              </td>
              <td class="text-center bg-diceClosePrimary">
                <div v-if="scores.playerFour">
                  <span class="font-weight-bold">{{
                    checkUpperSubtotalPlayerFour !== 0
                      ? checkUpperSubtotalPlayerFour
                      : ''
                  }}</span>
                </div>
              </td>
            ...
            <tr>
              ...
              <td class="text-center bg-diceClosePrimary border-darker">
                <div v-if="scores.playerThree">
                  <span class="font-weight-bold">{{
                    checkUpperTotalPlayerThree !== 0
                      ? checkUpperTotalPlayerThree
                      : ''
                  }}</span>
                </div>
              </td>
              <td class="text-center bg-diceClosePrimary">
                <div v-if="scores.playerFour">
                  <span class="font-weight-bold">{{
                    checkUpperTotalPlayerFour !== 0
                      ? checkUpperTotalPlayerFour
                      : ''
                  }}</span>
                </div>
              </td>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices &&
                      isPlayerTurnOne &&
                      scores.playerOne.threeOfAKind === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
                ...
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnTwo &&
                        scores.playerTwo.threeOfAKind === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerThree">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnThree &&
                        scores.playerThree.threeOfAKind === null
                    "
                    :disabled="playerThree()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerFour">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnFour &&
                        scores.playerFour.threeOfAKind === null
                    "
                    :disabled="playerFour()"
                    variant="plain"
                    height="23"
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices &&
                      isPlayerTurnOne &&
                      scores.playerOne.fourOfAKind === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
                ...
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnTwo &&
                        scores.playerTwo.fourOfAKind === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerThree">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnThree &&
                        scores.playerThree.fourOfAKind === null
                    "
                    :disabled="playerThree()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerFour">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnFour &&
                        scores.playerFour.fourOfAKind === null
                    "
                    :disabled="playerFour()"
                    variant="plain"
                    height="23"
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices &&
                      isPlayerTurnOne &&
                      scores.playerOne.fullHouse === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
                ...
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnTwo &&
                        scores.playerTwo.fullHouse === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerThree">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnThree &&
                        scores.playerThree.fullHouse === null
                    "
                    :disabled="playerThree()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerFour">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnFour &&
                        scores.playerFour.fullHouse === null
                    "
                    :disabled="playerFour()"
                    variant="plain"
                    height="23"
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices &&
                      isPlayerTurnOne &&
                      scores.playerOne.smallStraight === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
                ...
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnTwo &&
                        scores.playerTwo.smallStraight === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerFour">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnFour &&
                        scores.playerFour.smallStraight === null
                    "
                    :disabled="playerFour()"
                    variant="plain"
                    height="23"
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices &&
                      isPlayerTurnOne &&
                      scores.playerOne.largeStraight === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
                ...
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnTwo &&
                        scores.playerTwo.largeStraight === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerFour">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnFour &&
                        scores.playerFour.largeStraight === null
                    "
                    :disabled="playerFour()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.dice === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.dice === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center border-lighter">
                <v-btn
                  v-if="
                    isDices && isPlayerTurnOne && scores.playerOne.chance === null
                  "
                  :disabled="playerOne()"
                  variant="plain"
                  height="23"
              ...
              <td class="text-center border-lighter">
                <div v-if="scores.playerTwo">
                  <v-btn
                    v-if="
                      isDices && isPlayerTurnTwo && scores.playerTwo.chance === null
                    "
                    :disabled="playerTwo()"
                    variant="plain"
                    height="23"
                ...
                <div v-if="scores.playerThree">
                  <v-btn
                    v-if="
                      isDices &&
                        isPlayerTurnThree &&
                        scores.playerThree.chance === null
                    "
                    :disabled="playerThree()"
                    variant="plain"
                    height="23"
            ...
            <tr>
              ...
              <td class="text-center bg-diceClosePrimary border-darker">
                <div v-if="scores.playerThree">
                  <span class="font-weight-bold">{{
                    checkLowerTotalPlayerThree !== 0
                      ? checkLowerTotalPlayerThree
                      : ''
                  }}</span>
                </div>
              </td>
              <td class="text-center bg-diceClosePrimary">
                <div v-if="scores.playerFour">
                  <span class="font-weight-bold">{{
                    checkLowerTotalPlayerFour !== 0
                      ? checkLowerTotalPlayerFour
                      : ''
                  }}</span>
                </div>
              </td>
