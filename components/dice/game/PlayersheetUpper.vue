<template>
  <div class="left-column">
    ...
    <button
      class="button-scoreboard svg-container"
      @click="$emit('open-scoreboard')"
    >
      <svg
        fill="#ffffff"
        version="1.1"
...
defineProps<{
  upperPlayerSheet: PlayerSheetRow[];
  upperPlayerSheetBonus: number;
  upperPlayerSheetTotal: number;
